...
const CACHE_NAME = 'multios-pro-v63';
...
self.addEventListener('fetch', event => {
  ...
  if (navegacao) {
    event.respondWith((async () => {
      try {
        ...
        // ignoreSearch permite que /index.html?v=63 use /index.html do pré-cache.
  ...
  event.respondWith((async () => {
    // Nos arquivos locais, ignora apenas a query de versão (?v=63).
