...
const pecasDeFabrica = [
    ...
    // v85: peças adicionadas ao catálogo oficial - osmose reversa e componentes relacionados
    { c: "PVC.015.0338", n: "PAINEL ADESIVO P/ OSMOSE REVERSA 450X110MM" },
    { c: "PAR.104.0014", n: "PARAFUSO AUTO ATARRAXANTE CAB PANELA PHILLIPS 4,8X13MM AÇO INOX 304" },
    { c: "OSM.000.0000", n: "CARC. 10\"X2. 1/2\" BR/TR ROS 1/4\" T PLANA COD CA10/2BT14 EK TRANSPARENTE" },
    { c: "OSM.000.0001", n: "CARC. 10\"2.1/2\"BR/BR ROS 1/4\" T PLANA COD CA10/2BB 14 EK BRANCO" },
    { c: "OSM.000.0002", n: "FILTRO POLIPROPILENO LISO 10\"X2.1/2\" 5M COD CPLI10/2-5MY" },
    { c: "OSM.000.0003", n: "FILTRO DE CARVAO ATIVADO COMP 10\"X2.1/2\" 5M COD CCBI10/2-5MTY" },
    { c: "OSM.000.0004", n: "MEMBRANA P/OSMOSE REVER. DE 50 GPD COD MOR50H" },
    { c: "OSM.000.0005", n: "CARCAÇA P/MEMBRANA DE OSMOSE REVER.COD CAMOR 18-FLL/Y" },
    { c: "OSM.000.0007", n: "RESTRITOR DE FLUXO 50 GPD MANG 1/4\" COD RF50Y" },
    { c: "OSM.000.0008", n: "BOMBA P/OSMOSE REVERSA DE 50 GPD COD BOR50H" },
    { c: "OSM.000.0014", n: "CLIP P/FILTRO DE 2.1/\" COD CLIP25H" },
    { c: "OSM.000.0015", n: "CONEC MACHO MANG ENG.RAP. 1/4\" ROSCA 1/8\" COD.PI010821WY" },
    { c: "OSM.000.0016", n: "COTOVELO FIXO ENG.RAPIDO P/MANGUEIRA 1/4\" ROSCA 1/4\" CI480822W" },
    { c: "OSM.000.0017", n: "CHAVE P/CARCAÇA 5\" OU 10\"X2.1/2\" COD. CHACA1H" },
    { c: "OSM.000.0018", n: "COTOVELO MACHO MANG 1/4\" ROS 3/8\" CERT NSF FDA COD PI480823WM" },
    { c: "OSM.000.0019", n: "MANGUEIRA DE 1/4\" BRANCA COD. MANG14BR/MP" },
    { c: "OSM.000.0020", n: "MANGUEIRA DE 1/4\" AZUL COD. MANG14AZ-MKK" },
    { c: "OSM.000.0021", n: "MANGUEIRA 1/4\" VERMELHA COD. MANG14VE/MP" },
    { c: "OSM.000.0022", n: "PRESSOSTATO OR MANG 1/4\" ALTA PRESSAO PTOR14K" },
    { c: "OSM.000.0023", n: "CONECTOR MACHO ENG.RAPIDO 1-4 ROSCA 1-4 COD.PIO10822WH" },
    { c: "OSM.000.0024", n: "COTOVELO COM ENTRADA RAPIDA PARA MANG.1/4 CI0308W" },
    { c: "OSM.000.0025", n: "NIPLE PASSAFURO ENTRADA E SAIDA D MANG.1/4\" COD PI1208WD" },
    { c: "OSM.000.0027", n: "VALVULA COM FIXAÇÃO RAPIDA MANGUEIRAS 1-4 COD.TORL1414M-JG" },
    { c: "OSM.000.0028", n: "VALVULA SHUT OF 1-4 SPRINGWAY" },
    { c: "OSM.000.0029", n: "TRANSFORMADOR P/ BOR50H BIVOLT - COD. TBOR50-BVH" },
    { c: "OSM.000.0030", n: "DERIVAÇÃO PARA PURIFICADOR - MANGUEIRA ¼ - ROSCA BSP ¾. CPT34BSP/14D" },
    { c: "OSM.000.0033", n: "PORCA DE APERTO 1/4\" CODIGO N-0-4WKK" },
    { c: "PVC.015.0499", n: "ETIQUETA DE VOLTAGEM BIVOLT 25X100MM VINIL." },

    // v86: peças adicionadas a partir do banco2.txt; duplicadas e códigos já existentes foram ignorados
    { c: "ELE.005.0023", n: "CABO PP 3X1,5MM²X1,5MT PT PLUG 3CO 15A 4,8MM NBR14136" },
    { c: "ELE.012.0002", n: "FONTE HARTRONIC MOD LRS-150-24V" },
    { c: "ELE.017.0016", n: "MICRO MOTOR MM-20B C/ HELICE 255 MM 1550RPM 110/220V 60HZ" },
    { c: "REF.005.2003", n: "COMPRESSOR HERMETICO EMBRACO FFI12HBX 220V 60HZ" },
    { c: "ELE.015.3901", n: "PLACA CAPACITADOR NETICA PL CAP V1 R1 220V" },
    { c: "REF.004.0018", n: "TUBO DE COBRE Ø1/2" },
    { c: "USI.004.0005", n: "ESPAÇADOR ØE13XØ10XX12MM ALUMINIO" },
    { c: "USI.008.0171", n: "SUPORTE DE FIXAÇAO DO PT-100 Ø13X18MM LATAO PINTADO" },
    { c: "USI.014.0004", n: "CONEXAO P/ MANGUEIRA 3/8 OSCA 1/2 UNFX52MM CROMADO" },
    { c: "USI.014.0018", n: "ADAPTADOR C/ ROSCA 5/8 UNF 20MM CROMADO" },
    { c: "MAP.003.0022", n: "CHAPA DE ALUMINIO 2000X1000X1MM" },
    { c: "ELE.004.0044", n: "BOTAO DE COMANDO DUPLO METALTEX P20-BP-L-1C S/ ILUMINAÇAO" },
    { c: "ELE.005.0018", n: "PRENSA CABO PLASTICO REF-PG-9" },
    { c: "ELE.005.0046", n: "CABO PP 3X1,50MM2" },
    { c: "ELE.001.0091", n: "BOTÃO DE COMANDO ROTATIVO COD. P20 SS R 2 B 1A METALTEX" },
    { c: "ELE.004.0047", n: "BOTÃO DE COMANDO AMARELO METALTEX MOD. P20-BF-R-(PUSH)-Y-1A" },
    { c: "ELE.036.0006", n: "BORNE SK25 - MOD. K 2.5 - 24A STECK" },
    { c: "ELE.036.0007", n: "TAMPA DE PROTEÇÃO STP25 - MOD. TAMPA 2.5 - STECK" },
    { c: "ELE.036.0008", n: "POSTE FINAL SKEW35 STECK" },
    { c: "ELE.014.0033", n: "DISJUNTOR TERMOMAG. SIEMENS 5SX1 210-7 BIPOLAR C 10A" },
    { c: "ELE.004.0050", n: "BOTAO DE COMANDO COGUMELO VERMELHO NF COD. P20BKR-R-1B METALTEX" },
    { c: "ELE.007.0085", n: "CONTATO NC MOD M20-1B PARA BOTAO DE COMANDO" },
    { c: "MEC.025.0010", n: "TUBO DE PU ØEXT6,0MM" },
    { c: "MEC.025.0040", n: "CONEXÃO INSTANTANEA RETA SEXTAVADA P/TUBO PU Ø6MM ROSCA 1/4NPT INOX KQG2H06-02S" },
    { c: "ELE.007.0089", n: "RELE PARADA DE EMERGENCIA CP-D WEG" },
    { c: "ELE.005.0139", n: "CABO PP BRANCO 5X1,00MM2" },
    { c: "ELE.004.0054", n: "IDENTIFICADOR DE EMERGÊNCIA Ø60MM P20 METALTEX" },
    { c: "ELE.022.0057", n: "RESISTÊNCIA CARACOL MED.175MM 1200W 220V INOX" },
    { c: "ELE.027.0037", n: "MARCADOR MILLENIUM MHG2/5 SIMBOLO DE TERRA" },
    { c: "MAN.005.0125", n: "BANDEJA DE REFRIGERAÇAO 360X360MM AÇO CARBONO" },
    { c: "ELE.039.0036", n: "CONTATO MACHO 3 POLOS 10A + PINO TERRA PD03M IP-44" },
    { c: "ELE.039.0037", n: "CONTATO FEMEA 3 POLOS 10A + PINO TERMINAL MOLA PD03F IP-44" },
    { c: "ELE.039.0038", n: "BASE PLASTICA VERTICAL PD03W IP-44" },
    { c: "ELE.039.0039", n: "CARCAÇA PLASTICA SAIDA SUPERIOR PD03K IP-44" },
    { c: "ELE.039.0040", n: "PRENSA CABO ZAP11AP IP-44" },
    { c: "MEC.025.0051", n: "CONEXÃO INSTANTANEA COTOVELO MACHO P/TUBO PU Ø6MM ROSCA 1/4NPT INOX KQG2L06-02S" },
    { c: "MEC.019.0006", n: "MANOMETRO DIGITAL SMC ISE30A-C6H-N-M-L-B-K CALIBRADO 0-3 BAR" },
    { c: "MEC.999.0154", n: "ACOPLADOR DE SMC KK4S-02MS SOQUETE" },
    { c: "MEC.999.0155", n: "REGULADOR DE PRESSAO FESTO LRP-1/4- 4" },
    { c: "ELE.999.0156", n: "TEMPORIZADOR DIGITAL COEL TT34-LCRR CALIBRADO" },
    { c: "USI.999.1512", n: "ESTRUTURA PARA REFRIGERAÇÃO - BANHO" },
    { c: "USI.999.1514", n: "SUPORTE DE FIXAÇÃO DO MOTOR ØEXT101.6X 15MM ALUMINIO" },
    { c: "USI.999.1515", n: "TAMPO PARA DRENO" },
    { c: "USI.999.1516", n: "TUBO PARA DOBRADIÇA" },
    { c: "USI.999.1517", n: "BLOCO DE ALUMINIO 1\" X 1\" - CONEXÃO" },
    { c: "ELE.007.0051", n: "SINALEIRO MINI LED TPN-11 7 L G 24VDC METALTEX" },
    { c: "ELE.004.0056", n: "SINALIZADOR SONORO VERDE BZ20-7LY 24VDC METALTEX" },
    { c: "MEC.999.0157", n: "VALVULA DE ESFERA 1/2 -INOX 304" },
    { c: "ELE.007.0096", n: "CONTATOR WEG CWC07-10-30-C03 24VCC" },
    { c: "ELE.999.0211", n: "CONTROLADOR C704 - 24VCC - RETRANSM. - COD. C704-500ES-2 CONTEMP" },
    { c: "ELE.039.0041", n: "SOQUETE MACHO 4 POLOS 10A + PINO TERRA PD04M IP-44" },
    { c: "ELE.039.0042", n: "SOQUETE FEMEA 4 POLOS 10A + PINO TERRA PD04F IP-44" },
    { c: "ELE.001.0102", n: "CHAVE ROTATIVA LIGA DESLIGA STECK MOD TH2/20E" },
    { c: "ELE.014.0070", n: "DISJUNTOR TERMOMAG. SIEMENS 5SX1 216-7 BIPOLAR C 16A" },
    { c: "MAP.999.0307", n: "PAINEL ADESIVO COMANDO BANHO B.BRAUN 568X152MM" },
    { c: "MAP.999.0308", n: "PAINEL ADESIVO CABEÇOTE PARA BANHO B. BRAUN 156 X 125MM" },
    { c: "PAR.135.3067", n: "PARAFUSO CABEÇA SEXTAVADA M4X4MM AÇO INOX AISI 304" },
    { c: "MAP.999.0311", n: "PAINEL ADESIVO SUPERIOR CABEÇOTE BANHO B. BRAUN 300X160MM" },
    { c: "USI.023.0207", n: "BOMBA DE AGITAÇÃO ESPECIAL Ø101.4 X 210MM AÇO INOX" },
    { c: "MAN.026.0300", n: "FLAT 26 VIAS 300MM" },
    { c: "ELE.017.0003", n: "MICROREDUTOR 24-26 RPM BIVOLT 60HZ- MOD P-MI-30" },
    { c: "ELE.020.0001", n: "PASSADOR DE FIO 3/8X1/2 REF 6706" },
    { c: "ELE.015.1701", n: "PLACA FONTE DO TIMER NEFT 2.0 1D 220V" },
    { c: "ELE.015.6301", n: "PLACA FRONTAL NE F TMR1D V2R2 (LED VERDE)" },
    { c: "PVC.015.0017", n: "PAINEL ADESIVO 261X86MM FRIABILIDADE 1 E" },
    { c: "PAR.202.6011", n: "PARAFUSO PHILIPS CABEÇA CILINDRICA M4X15MM AÇO INOX 304" },
    { c: "USI.009.0003", n: "FIXADOR RECARTILHADO Ø3/4X19MM C/ ROSCA M8 ALUMINIO" },
    { c: "ELE.013.0003", n: "FUSIVEL DE VIDRO PEQUENO 2A 250V TIPO 20AG" },
    { c: "USI.001.0137", n: "EIXO P/ MOTOR Ø5/8\"X120MM INOX (FRIABILIDADE V.2)" },
    { c: "ACR.003.0035", n: "CONJUNTO DA CUBA ØE301 ØI287X37MM ACRILICO COMPLETO VERSAO II" },
    { c: "USI.015.0045", n: "PINO Ø25X51MM ACRILICO P/ CUBA ACR.003.0035 FRIABILOMETRO" },
    { c: "MAP.003.0004", n: "CHAPA #24 INOX AISI 430 3000X1250X0,6MM C/PVC AZUL" },
    { c: "ELE.018.0055", n: "RESISTENCIA SILICONE TC 220V 24W/M 4220MM" },
    { c: "MAP.500.2005", n: "FILTRO DE CARVAO ATIVADO CARVO ACTIVE DG C470XA196XP263MM" },
    { c: "ELE.024.0008", n: "SENSOR PT 100 L Ø4,7MM200°C INOX C/ RABICHO 1,5M" },
    { c: "REF.007.0089", n: "GAXETA IMANTADA MED 1665X725X17MM" },
    { c: "ELE.015.2711", n: "PLACA FONTE L/D V0RV0 NORMAL AM BIVOLT" },
    { c: "MAN.002.0039", n: "SUPORTE DE FIXAÇAO DO TERMOSTATO 56X35X21MM AÇO CARBONO" },
    { c: "MAP.015.0108", n: "PAINEL ADESIVO 97X606MM CAMARA FRIA DISPLAY LED" },
    { c: "MEC.004.0012", n: "PUXADOR MODELO A EMBUTIDO COD 92998" },
    { c: "MAP.003.0005", n: "####CHAPA #16 AÇO CARBONO 2500X1200X1,5 MM FINA FRIO" },
    { c: "USI.999.1026", n: "CONJUNTO DO DAMPER PLASTICO ESPECIAL" },
    { c: "MAC.002.0022", n: "CAIXA DE PAPELAO CINTA/TAMPA 860X1080X1940MM KP-435" },
    { c: "ELE.007.0020", n: "CONTATOR MINI TRIP 220V 50/60HZ CW07-01-30-D23 1NF" },
    { c: "ELE.007.0005", n: "DISSIPADOR DE CALOR DS2" },
    { c: "FAB.004.0066", n: "CHAVE ALLEN 2MM" },
    { c: "FAB.004.0083", n: "CHAVE FIXA 16/17MM BELZER 300023B" },
    { c: "FAB.004.0087", n: "CHAVE ALLEN 4MM" },
    { c: "ARU.010.0003", n: "ARRUELA LISA M5 AÇO INOX 304" },
    { c: "ARU.010.0005", n: "ARRUELA LISA M8 AÇO INOX 304" },
    { c: "ELE.022.0080", n: "RESISTENCIA CARACOL PEQUENA 2000W 220V INOX" },
    { c: "MAP.006.0004", n: "MANGUEIRA SILICONE ØE12XØI 6MM" },
    { c: "MEC.020.0007", n: "ANEL O'RING ØI 3,90X1,80MM" },
    { c: "MEC.020.0012", n: "ANEL O'RING ØI9,19X2,62MM VITOM MARROM" },
    { c: "MEC.020.0028", n: "ANEL O'RING ØI14X2,65MM VITON MARROM" },
    { c: "USI.027.0024", n: "PORCA FLANGEADA C/ ROSCA UNF PARAL 5/8 P/ TUBO 3/8 LATAO" },
    { c: "USI.027.0020", n: "PORCA SEXTAVADA 7/8\" C/ ROSCA 5/8\" UNFX5MM LATAO" },
    { c: "PAR.104.0015", n: "PARAFUSO PHILIPS CABEÇA CHATA M5X8MM AÇO INOX 304" },
    { c: "PAR.105.0001", n: "PARAFUSO ALLEN M10X50MM AÇO INOX 304" },
    { c: "PAR.202.6004", n: "PARAFUSO ALLEN M8X45MM CABEÇA CILINDRICA DIN 912 AÇO INOX 304" },
    { c: "PAR.235.3052", n: "PARAFUSO ALLEN M5X20MM AÇO INOX 304" },
    { c: "VDR.002.0004", n: "COPO VIDRO C/FUNDO ABAULADO ØE105X168MM" },
    { c: "MEC.299.0111", n: "CESTO MALHA 40 DISSOLUTOR NOVA ETICA" },
    { c: "ACR.002.0003", n: "TAMPA Ø109X16MM ACRILICO LEITOSO" },
    { c: "MAP.003.0010", n: "CHAPA #14 AÇO CARBONO 2000X1200X1,9MM FINA FRIO" },
    { c: "USI.011.0039", n: "BUCHA CENTRALIZADORA Ø14X30MM" },
    { c: "MEC.299.0119", n: "COLETOR MANUAL DE 15 CM P/ DISSOLUTORES NOVA ETICA" },
    { c: "MAP.003.0021", n: "CHAPA #14 INOX AISI 304 2000X1200X1,90MM - COM PVC" },
    { c: "MEC.007.0029", n: "FECHO LINGUETA REG. MINI MIOLO FENDA CÓD. 28511 TASCO" },
    { c: "ELE.013.0022", n: "FUSIVEL DE VIDRO GRANDE 12A 250VCA TIPO 3AG" },
    { c: "ARU.010.0002", n: "ARRUELA LISA M10 ZINCADA" },
    { c: "ARU.130.0012", n: "ARRUELA DE PRESSAO M10 ZINCADA" },
    { c: "ARU.130.0013", n: "ARRUELA DE PRESSAO M8 ZINCADO" },
    { c: "PAR.001.0002", n: "PARAFUSO DE CABEÇA CHATA COM SEXTAVADO INTERNO DIN 7991 M4X10 INOX" },
    { c: "USI.012.0090", n: "POLIA SINCRONIZADORA T 2,5 40 DENTES 6F FURO Ø10MM" },
    { c: "USI.012.0092", n: "POLIA SINCRONIZADORA T 2,5 40DENTES 6F FURO Ø15MM" },
    { c: "MEC.005.0000", n: "CORREIA SINCRONIZADORA T2,5 380MM LARGURA 6MM" },
    { c: "USI.022.0116", n: "CONJUNTO TAMPA CENTRALIZADORA 138X138X10MM DTS" },
    { c: "PAR.135.3064", n: "PARAFUSO ALLEN SEM CABEÇA M5X10MM 304 INOX 304" },
    { c: "PAR.001.0097", n: "PARAFUSO CAB. CHATA SEXT. INT. DIN 7991 M6X20 AÇO INOX 304" },
    { c: "MEC.299.1100", n: "HASTE 425MM Nº1 P/ CESTO DTS" },
    { c: "MEC.299.2000", n: "HASTE 425MM Nº2 P/ CESTO DTS" },
    { c: "MEC.299.3000", n: "HASTE 425MM Nº3 P/ CESTO DTS" },
    { c: "MEC.299.4000", n: "HASTE 425MM Nº4 P/ CESTO DTS" },
    { c: "MEC.299.5000", n: "HASTE 425MM Nº5 P/ CESTO DTS" },
    { c: "MEC.299.6000", n: "HASTE 425MM Nº6 P/ CESTO DTS" },
    { c: "USI.008.0185", n: "SUPORTE DE APOIO Ø13X195MM ALUMINIO" },
    { c: "MEC.299.1011", n: "PA 155MM N°1 P/ DISSOLUTOR NOVA ETICA" },
    { c: "MEC.299.2011", n: "PA 155MM N°2 P/ DISSOLUTOR NOVA ETICA" },
    { c: "MEC.299.3011", n: "PA 155MM N°3 P/ DISSOLUTOR NOVA ETICA" },
    { c: "MEC.299.4011", n: "PA 155MM N°4 P/ DISSOLUTOR NOVA ETICA" },
    { c: "MEC.299.5011", n: "PA 155MM N°5 P/ DISSOLUTOR NOVA ETICA" },
    { c: "MEC.299.6011", n: "PA 155MM N°6 P/ DISSOLUTOR NOVA ETICA" },
    { c: "MEC.299.1004", n: "SUPORTE 125MM N°1 P/ FIXAÇAO DO CESTO C/ O´RING NOVA ETICA" },
    { c: "MEC.299.2004", n: "SUPORTE 125MM N°2 P/ FIXAÇAO DO CESTO C/ O´RING NOVA ETICA" },
    { c: "MEC.299.3004", n: "SUPORTE 125MM N°3 P/ FIXAÇAO DO CESTO C/ O´RING NOVA ETICA" },
    { c: "MEC.299.4004", n: "SUPORTE 125MM N°4 P/ FIXAÇAO DO CESTO C/ O´RING NOVA ETICA" },
    { c: "MEC.299.5004", n: "SUPORTE 125MM N°5 P/ FIXAÇAO DO CESTO C/ O´RING NOVA ETICA" },
    { c: "MEC.299.6004", n: "SUPORTE 125MM N°6 P/ FIXAÇAO DO CESTO C/ O´RING NOVA ETICA" },
    { c: "PAR.202.6013", n: "PARAFUSO ALLEN M8X30MM AÇO INOX 304" },
    { c: "ACR.002.0071", n: "TAMPA Ø134X5MM C/ FURO Ø12MM ACRILICO" },
    { c: "ACR.030.0037", n: "ESTOJO ACRILICO 225X225X95MM PARA CESTOS, HASTES E ACESSÓRIOS DISSOLUTOR" },
    { c: "USI.013.0032", n: "ANEL LIMITADOR INFERIOR Ø32X35MM ALUMINIO DTS" },
    { c: "USI.013.0034", n: "ANEL LIMITADOR SUPERIOR Ø31X15MM ALUMINIO DTS" },
    { c: "USI.013.0035", n: "ANEL REGULADOR DA HASTE DISSOLUTOR Ø22X15MM ALUMINIO" },
    { c: "USI.022.0332", n: "CONJ. SISTEMA TRANSM. P/ CABEÇOTE 6 PROVAS 644X495X137MM DTS" },
    { c: "USI.022.0235", n: "CONJUNTO DO MANCAL ROL 6001 COM EIXO DTS" },
    { c: "MEC.999.0021", n: "ABRAÇADEIRA ROSCA SEM FIM INOX P/ Ø25-38" },
    { c: "ACR.299.0002", n: "ESTOJO ACRILICO 455X212X63MM PARA HASTES E PÁS DISSOLUTOR" },
    { c: "MAC.002.0099", n: "PAPELAO EM CHAPA 3000 X 2420 QUALID KK120 W" },
    { c: "USI.005.0113", n: "ESFERA PADRÃO Ø25MM POLIACETAL P/ CALIBRAÇÃO DA HASTE DO DISSOLUTOR" },
    { c: "USI.022.0307", n: "CONJ SOLDADO COTOVELO Ø32MM ROSCA M18X1,5 MANGUEIRA 3/4 INOX ELETROPOLIDO" },
    { c: "USI.027.0012", n: "PORCA SEXTAVADA 25X10MM ROSCA M18X1,5 INOX" },
    { c: "ELE.005.0140", n: "CABO PP SILICONE BRANCO MULTIPLO 7X1,00MM2" },
    { c: "USI.022.0242", n: "CONJ POÇO TERMOMETRICO RETO FLANG ØE3/8 XØI7X148MM INOX" },
    { c: "MEC.020.0060", n: "ARRUELA VEDAÇÃO ØI100XØE120X5MM 110°C BORRACHA NITRILICA" },
    { c: "ELE.039.0043", n: "CONECTOR AC MACHO IEC 60320 C14 (INLET) 15A ENCAIXE RAPIDO COD 2010" },
    { c: "PVC.015.0636", n: "PAINEL ADESIVO TRASEIRO 125X35MM DISSOLUTOR" },
    { c: "ELE.025.0097", n: "CARCAÇA CONECTOR MULTIPLO 16 POLOS PC16L KAP" },
    { c: "ELE.025.0098", n: "BASE CONECTOR MULTIPLO 16 POLOS PC16B KAP" },
    { c: "ELE.025.0099", n: "SOQUETE FEMEA CONECTOR MULTIPLO 16 POLOS PC16F KAP" },
    { c: "ELE.025.0100", n: "SOQUETE MACHO CONECTOR MULTIPLO 16 POLOS PC16M KAP" },
    { c: "USI.001.0169", n: "EIXO Ø19X42MM INOX" },
    { c: "MAP.008.0011", n: "BOMBA MAGNETICA 220V 50/60HZ 12 L/MIN MP-10RM" },
    { c: "ACR.001.0103", n: "TAMPA CUBA DISSOLUTOR 6 PROVAS 690X405X20MM ACRILICO LEITOSO" },
    { c: "USI.022.0338", n: "CONJUNTO CILINDRO AQUECEDOR Ø140X144MM SOLDADO INOX" },
    { c: "MEC.011.0226", n: "LUVA ROSCA FEMEA 1/2 INOX" },
    { c: "MEC.011.0227", n: "COTOVELO ROSCA FEMEA 1/2 INOX" },
    { c: "USI.021.0091", n: "MANIPULO RECARTILHADO C/ ROSCA M5 Ø25 POLIACETAL" },
    { c: "PVC.015.0661", n: "PAINEL ADESIVO CIRCUALDOR 140X50MM DISSOLUTOR" },
    { c: "PVC.015.0665", n: "PAINEL EM POLICARBONATO TEXTURIZADO 0,25 C/ ADESIVO 9767 DISSOLUTOR 198X133 MM" },
    { c: "PVC.015.0667", n: "PAINEL EM POLICARBONATO TEXTURIZADO 0,25 C/ ADESIVO 9767 ETHIKTECHNOLOGY 198X133 MM" },
    { c: "ACR.003.0044", n: "CAIXA IHM WECON DISSOLUTOR 250X185X65MM ACRILICO LEITOSO" },
    { c: "PVC.015.0669", n: "LETRAS ADESIVAS ETHIK 30X10MM" },
    { c: "ACR.014.0092", n: "ADAPTADOR 20X80X40 ROSCA 1/4BSP-1/4BSP ACRILICO" },
    { c: "USI.026.0034", n: "PARAFUSO C/ ROSCA 1/4BSPX24MM LATAO" },
    { c: "ACR.008.0036", n: "CUBA CONFORMADA 660X375X198MM FUROS Ø10-Ø13-Ø18MM ACRILICO" },
